...
class SharedDataMiddleware:
    ...
    """A WSGI middleware which provides staic content for development
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/staic': ('myapplication', 'staic')
        })

    This will then serve the ``staic`` folder in the `myapplication`
    Python package.
    ...
    only file names for staic files.
