...
(
    ...
    dew_point                 REAL,
    dew_point_flag            VARCHAR(1),
    heat_index                REAL,
    heat_index_avg            VARCHAR(1),
    pressure                  REAL,
    pressure_flag             VARCHAR(1),
    wind_speed                REAL,
    wind_speed_flag           VARCHAR(1),
    wind_calm_percentage      REAL,
...
(
    ...
    dew_point_avg               REAL,
    dew_point_avg_flag          VARCHAR(1),
    heat_index_avg              REAL,
    heat_index_avg_flag         VARCHAR(1),
    pressure_avg                REAL,
    pressure_avg_flag           VARCHAR(1),
    wind_speed_avg              REAL,
    wind_speed_avg_flag         VARCHAR(1),
    wind_calm_percentage        REAL,
    wind_calm_percentage_flag   VARCHAR(1),
    PRIMARY KEY (station_id, month),
    FOREIGN KEY (station_id) REFERENCES Stations (id),
